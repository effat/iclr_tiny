...
def do_run(k, args):
    ...
    print("Done Fold ", fold_)

    ### retrn auc and acc
    return (auc_test, acc_test, ablation_fname)
...
if __name__ == "__main__":
    ...
    for i in range(start_k, end_k):
        auc_test, accuracy_test, ablation_fname = do_run(i, args)
    ...
    textfile.close()
    #print(ablation_type)
    #print("Average AUC ", np.mean(all_auc_test))
    #print("Average Accuracy ", np.mean(all_accuracy_test))
