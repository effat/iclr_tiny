...
from model_TimeEncode_iclr_Ablation import SRL_KT
from utils import *
...
def do_ablation(k, args):
   ### Resp dict in SRL_removed_df folder
    ...
    ablation = {"time_include": False, "qrelation_include": True, "qrespCos_include": True}

    ablation_fname = "  time_include__" + str(ablation["time_include"]) + "  qrelation_include__" + str(ablation["qrelation_include"]) + "  qrespCos_include__" + str(ablation["qrespCos_include"])
    ...
    fname = str(args.savedir) + fold_+ "_ablation_paramsize.txt"
